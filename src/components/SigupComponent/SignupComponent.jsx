      ...
      <div className="container1">
        ...
        <Row style={{padding: "50px 0 50px 0" , borderRadius: "10px"}}>
          <Col span={12} style={{padding: "50px 60px" , fontSize: "20px" , backgroundColor: "white"}} >
            ...
            <input style={{width : "100%" , height: "25px", marginBottom: "20px"}}  type="text" placeholder="Password" name="" id="" />
            <input style={{width : "100%" , height: "25px"}}  type="text" placeholder="Confirm Password" name="" id="" />
            <button  className="btn1" >Đăng nhập</button> <br />
            <span style={{fontSize: "15px"}}> <a href="#" className="link" >Đăng nhập ngay</a> </span>
          </Col>
